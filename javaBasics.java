...
public class javaBasics{
    ...
    // Literals => whose value doesn’t change
    // Ex 2(a+b)
    // 2=> literal
    // a,b => variables

    // a,b,c,main,print etc => identifiers
    //     Data Types:
    //     • Premitive (Already there)
    //     1. Byte 1 byte [-128 to 128]
    //     2. Short 2 byte
    //     3. Char 2 byte
    //     4. Boolean 1 byte [true false]
    //     5. Int 4 byte [-2B to 2B]
    //     6. Long 8 byte
    //     7. Float 4 byte
    //     8. Double 8 byte
    ...
    // /*12. Ternary oprator => 3 oprands ||=> from (11.1) */
    // public static void main(String[] args) {
    ...
    //      */
    //     System.out.println(5^6);
    //     //33.1.3 Binary One's Complement => ~
    //     /*
    //      * 0 => 1
    //      * 1 => 0
    //      */
    ...
    // //33.3 Get Set Clear update clear last ith bit
    ...
    // //33.4 Check if number is power of 2 or not?
    ...
    // //33.5 Count set bits in a number
    // //ex. 10111 setBit=4
    ...
    // //33.7 Swap without using third variable
    // public static void main(String[] args){
    //     int a=5,b=4;
    //     // a=a+b;
    //     // b=a-b;
    ...
    // //33.8 add 1 to an integer using bit
    // public static void main(String[] args) {
